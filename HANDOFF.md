...
65 API + 7 gateway + 7 mathcheck tests pass. Show Dingba (photo input) and routine upload shipped. The stack was live-verified
...
SQL migrations 0000–0008 (apply in order). `apps/api` = Fastify: sessions
