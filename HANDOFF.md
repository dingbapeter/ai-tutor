...
64 API + 7 gateway + 7 mathcheck tests pass. Show Dingba (photo input) shipped. The stack was live-verified
...
SQL migrations 0000–0007 (apply in order). `apps/api` = Fastify: sessions
